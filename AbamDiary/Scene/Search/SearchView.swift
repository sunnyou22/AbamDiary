...
class SearchView: BaseView {
    ...
    let collectionView: UICollectionView = {
        let layout = SearchView.setLayout()
        ...
        view.register(MyHeaderFooterView.self, forSupplementaryViewOfKind: ElementKind.sectionHeader, withReuseIdentifier: ElementKind.sectionHeader)
        view.register(MyHeaderFooterView.self, forSupplementaryViewOfKind: ElementKind.sectionHeader_2, withReuseIdentifier: ElementKind.sectionHeader_2)
